 ...
 * 間隔: 横方向
 */
export const clsLayoutSpacingX = 'nws-layout-spacingX';

/**
 * 間隔: 縦方向
 */
export const clsLayoutSpacingY = 'nws-layout-spacingY';
 ...
 * 間隔: 横方向
 */
export const varLayoutSpacingX = '--nws-layout-spacingX';

/**
 * 変数\
 * 間隔: 縦方向
 */
export const varLayoutSpacingY = '--nws-layout-spacingY';
 ...
 * 横方向のテンプレート
 */
export const varLayoutTemplateX = '--nws-layout-childX';

/**
 * 変数\
 * 縦方向のテンプレート
 */
export const varLayoutTemplateY = '--nws-layout-childY';
