...
export const Stacking: Story = {
  args: { childSizeX: CHILD_SIZE_SMALL, childSizeY: CHILD_SIZE_SMALL, childCount: 3 },
};

// alignX
export const AlignXLeft: Story = {
  args: { alignX: 'left', childSizeX: CHILD_SIZE, childSizeY: CHILD_SIZE_SMALL, childCount: 1 },
};
export const AlignXCenter: Story = {
  args: { alignX: 'center', childSizeX: CHILD_SIZE, childSizeY: CHILD_SIZE_SMALL, childCount: 1 },
};
export const AlignXRight: Story = {
  args: { alignX: 'right', childSizeX: CHILD_SIZE, childSizeY: CHILD_SIZE_SMALL, childCount: 1 },
};

// alignY
export const AlignYTop: Story = {
  args: { alignY: 'top', childSizeX: CHILD_SIZE_SMALL, childSizeY: CHILD_SIZE, childCount: 1 },
};
export const AlignYMiddle: Story = {
  args: { alignY: 'middle', childSizeX: CHILD_SIZE_SMALL, childSizeY: CHILD_SIZE, childCount: 1 },
};
export const AlignYBottom: Story = {
  args: { alignY: 'bottom', childSizeX: CHILD_SIZE_SMALL, childSizeY: CHILD_SIZE, childCount: 1 },
};
